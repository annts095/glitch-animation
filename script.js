...
class Glitch {
  ...
  show() {
    ...
    if (!this.throughFlag) {
      ...
      image(this.imgOrigin, 0, 0, scaledWidth, scaledHeight);
      pop();
      return;
    }
    ...
    this.scatImgs.forEach(obj => {
      ...
      if (obj.img) {
        let scatScaledWidth = obj.img.width * this.scale;
        let scatScaledHeight = obj.img.height * this.scale;
        image(obj.img, obj.x, obj.y, scatScaledWidth, scatScaledHeight);
      }
      pop();
    });
